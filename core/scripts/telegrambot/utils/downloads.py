...
DOWNLOAD_LINKS = {
    ...
    "singbox": {
        "android": "https://github.com/SagerNet/sing-box/releases/download/v1.13.0-rc.3/SFA-1.13.0-rc.3-arm64-v8a.apk"
    },
    "v2ray": {
        "windows": "https://github.com/2dust/v2rayN/releases/download/7.17.3/v2rayN-windows-64-SelfContained.zip",
        "android": "https://github.com/2dust/v2rayNG/releases/download/2.0.9/v2rayNG_2.0.9_arm64-v8a.apk"
    }
}
