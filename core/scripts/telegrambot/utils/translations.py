...
BUTTON_TRANSLATIONS = {
    "en": {
        ...
        "purchase_plan": "💰 pay with crypto or cash",
    ...
    "fa": {
        ...
        "purchase_plan": "💰 پرداخت با رمزارز یا تومان",
