...
def register_payment_callback(callback: Callable[[str], None]):
    ...
    Args:
        callback: Function to call when a payment is completed.
                 Will be passed the order_id.
    """
